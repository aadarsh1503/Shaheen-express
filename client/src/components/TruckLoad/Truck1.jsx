...
const Truck1 = () => {
    ...
    <div className="relative lg:flex hidden  items-center font-noto-sans-display bg-white w-full min-h-[400px]">
      ...
      <div className="relative z-10 flex w-full top-[18px] max-w-6xl mx-auto">
        ...
        <div className="w-1/2 relative top-32 p-8">
          <p className="text-black mb-5">Truckload</p>
          <h2 className="text-3xl mb-5 font-semibold text-[#264795]">
          Global Truckload Solutions
          </h2>
          <p className="text-black mt-4">
          In today's world of ever-changing transportation markets, you need more capacity options to develop your supply chain. Improve your services and get competitive rates by tapping into Shaheen Express comprehensive suite of services.
          </p>
          <a href="/contact">
  ...
  <div class="relative z-10 flex flex-col-reverse lg:flex-row w-full top-[18px] max-w-6xl mx-auto">
    <div class="lg:w-1/2 w-full p-8">
      <p class="text-gray-600 mb-5">Truckload</p>
