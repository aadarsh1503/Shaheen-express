  ...
  return (
    <div className="relative bg-cover bg-center py-16  px-4" style={{ backgroundImage: `Url(${i3})` }}>
      <div className="max-w-4xl mx-auto">
        <FaLightbulb className="text-Red text-5xl  mb-4" />
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 mt-10 max-w-4xl mx-auto">
        {[
          ...
          <div key={item.id} className="text-center">
            <div className="w-14 h-14 flex items-center justify-center bg-Red text-white rounded-full text-lg font-bold mx-auto">
              {item.id}
            </div>
