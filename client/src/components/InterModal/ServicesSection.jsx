  ...
  return (
    <div className="flex items-center justify-center bg-gray-100 py-10">
      <div className="container flex flex-col md:flex-row items-center gap-10">
        {/* Left Column */}
        <div className="flex flex-col gap-10 w-full lg:p-0 p-4 md:w-1/3 text-center md:text-right">
          <div className="relative  text-center  lg:text-right bottom-8">
            <FaAngleDoubleRight className="text-Red text-5xl relative  bottom-6 lg:bottom-9 inline-block" />
            <h2 className="text-xl font-semibold relative  bottom-6 text-Blue">Cross Border</h2>
            <p className="text-gray-700 mt-2 lg:w-[200px] w-full  bottom-4 text-[14px] leading-6 relative inline-block">
          ...
          <div>
            ...
            <p className="text-gray-700 mt-2 w-full lg:w-[200px]  bottom-4 text-[14px] leading-6 relative inline-block">
        ...
        {/* Right Column */}
        <div className="flex flex-col gap-10 w-full md:w-1/3 lg:mt-0 mt-12 text-center md:text-left">
          <div>
            ...
            <p className="text-gray-700 mt-2 w-full lg:w-[200px]  bottom-11 text-[14px] leading-6 relative  ">
          ...
          <div>
            ...
            <p className="text-gray-700 mt-2 w-full lg:w-[200px]  bottom-4 text-[14px] leading-6 relative ">
